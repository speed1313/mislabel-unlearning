...
plt.legend()
dir = "result/unlearning/"

if not os.path.exists(dir):
    os.makedirs(dir)
plt.savefig(dir + f"{noise_ratio}_{CLASS_NUM}_{HIDDEN_SIZE}.png")
plt.show()

# result to csv

with open(f"result/unlearning/{noise_ratio}_{CLASS_NUM}_{HIDDEN_SIZE}.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(
        [
            "original_test_acc",
